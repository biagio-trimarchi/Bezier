...
constraints = @(x) nonLinearConstraintsOld(x, n, m, d, Q, Co, Pd, Ud, safeDist, A, b);
...
% hold off
% title('Tracjectories')
% legend('Obstacle Control Points', 'Obstacle Trajectory', 'Drone Control Points', 'Drone Trajectory')
% xlim([-1, 4])
% ylim([-1, 4])
% 
% figure(4)
...
% legend('Control Points', 'Safe Margin')
% 
% figure(7)
...
%     legend("Obstacle Trajectory", "Drone Trajectory", "Safe Circle", 'Location', 'southeast')
%     %drawnow 
%     
% end
% 
for tt =1:length(t)
    ...
    legend("Obstacle Trajectory", "Old Trjajectory", "New Trajectory", "Safe Circle", 'Location', 'southeast')
    drawnow 
    %F(tt) = getframe;
end
